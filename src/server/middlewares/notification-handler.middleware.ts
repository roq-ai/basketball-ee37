...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'team.update': {
    roles: ['league-owner', 'player', 'referee'],
    key: 'team-manager-updates-team',
    tenantPath: ['organization', 'team'],
    userPath: [],
  },
  'player.update': {
    roles: ['league-owner', 'team-manager'],
    key: 'player-updates-profile',
    tenantPath: ['organization', 'team', 'player'],
    userPath: [],
  },
  'game.update': {
    roles: ['league-owner', 'team-manager', 'player'],
    key: 'referee-updates-game-result',
    tenantPath: ['organization', 'team', 'game'],
    userPath: [],
  },
};
