...
export function TeamListPage(props: TeamListPageProps) {
    ...
    async () =>
      getTeams({
        relations: [
          'user',
          'organization',
          'game_game_team1_idToteam.count',
          'game_game_team2_idToteam.count',
          'player.count',
        ],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('game', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'game_game_team1_idToteam',
          header: 'Game Game Team 1 Id Toteam',
          accessorKey: 'game_game_team1_idToteam',
          cell: ({ row: { original: record } }: any) => record?._count?.game_game_team1_idToteam,
        }
      : null,
    hasAccess('game', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'game_game_team2_idToteam',
          header: 'Game Game Team 2 Id Toteam',
          accessorKey: 'game_game_team2_idToteam',
          cell: ({ row: { original: record } }: any) => record?._count?.game_game_team2_idToteam,
        }
      : null,
    hasAccess('player', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Player',
          accessorKey: 'player',
          cell: ({ row: { original: record } }: any) => record?._count?.player,
        }
      : null,
